...
### Step 2:
> -> After installing python successfully, now download the contents in the `main` folder from above. ***(Make sure that these three files are in the same folder)*** <br/>
> -> Navigate to the folder in command prompt and enter `pip install -r requirements.txt`
...
> -> Now drag the ***main.exe*** file, into the parent folder, and you're good to go!<br/>
