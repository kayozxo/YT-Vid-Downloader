...
def get_info(url):
    ...
    youtube = build(
        "youtube", "v3", developerKey="AIzaSyC54QjnV9FiDRyvwu2_JLoJgnmWq4VoLdo"
    )
...
with col1:
    vid_btn = ui.button(
        "Download Video", variant="secondary", key="vid_btn", class_name="w-full"
    )

with col2:
    aud_btn = ui.button(
        "Download Audio", variant="secondary", key="aud_btn", class_name="w-full"
    )
